...
const sections = [
  ...
  },
  {
    ...
    content: [
      "L'IA te pose des questions sur les procédures du karting et tu réponds à voix haute.",
      "1. Clique sur 'Conversations' dans le menu",
      "2. Clique 'Démarrer la conversation'",
      "3. L'IA va te saluer et poser une question",
      "4. Maintiens le gros bouton orange et parle dans ton micro",
      "5. Relâche — l'IA va répondre et poser la question suivante",
